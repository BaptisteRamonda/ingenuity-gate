...
{
    qmlRegisterSingletonType<Snapshot>("Snapshot", 1, 0, "Snapshot", &Snapshot::qmlSingleton);
    qmlRegisterSingletonType(QUrl("qrc:/qml/Snapshot/SnapshotTheme.qml"), "Snapshot", 1, 0, "SnapshotTheme");
}
...
int main(int argc, char *argv[])
{
    ...
    I2QmlHotReloader::instance().seturl(QUrl("qrc:/qml/Snapshot/Content.qml"));
